...
using CMPG323_Project2_37687638.Models;
using Microsoft.AspNetCore.Authorization;

namespace CMPG323_Project2_37687638.Controllers
{
    [Authorize]
    ...
    {
        private readonly Poject2Context _context;

        public OrderDetailsController(Poject2Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'Poject2Context.OrderDetails'  is null.");
          }
